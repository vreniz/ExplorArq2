...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "VALORESTETICO":
            ...
            $("#MapsFrame").attr("src", "https://www.google.com/maps/d/embed?mid=144v9Y9SZjjaXHCwth42N0B5hONBLhEQ&ehbc=2E312F");
            break;
        case "VALORHISTO":
            VALORHISTO_Img = true;
        ...
        case "ELEMENTOARQUITECTÓNICO":
            ...
            ChangeDescripcion('COLUMNAS');
            $("#ELEMENTOARQUITECTÓNICODescripcion").css('display', 'block');
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=6912b22921&commit=ef2b3c91a5&c=%5B27.6468%2C24.95484%2C20.55476%2C-1.83619%2C-2.25793%2C15.17046%2C0%2C1%5D ");
            break;
        case "DANZA":
            DANZA_Img = true;
            ChangeSelloImage('SELLO_DANZA');
            ChangeDescripcion('FRONTÓN');
            $("#DanzaDescripcion").css('display', 'block');
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=b8e04c7700&commit=f05b450310&c=%5B-5.29433%2C9.80102%2C1.35609%2C-8.62815%2C-2.80903%2C1.09506%2C0%2C1%5D&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "MEMORIA":
            MEMORIA_Img = true;
            ChangeSelloImage('SELLO_MEMORIA');
            ChangeDescripcion('VENTANAS');
            $("#MemoriaDescripcion").css('display', 'block');
            $("#ContainerDesctipcion").css('height', '36vh');
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=d9f2b1145d&commit=a8d58740f0&c=%5B-4.30671%2C8.05252%2C2%2C-5.1673%2C2.71405%2C2%2C0%2C1%5D&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "ARTESANIA":
            ARTESANIA_Img = true;
