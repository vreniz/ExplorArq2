...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "VALORESTETICO":
            ...
            $("#MapsFrame").attr("src", "https://www.google.com/maps/d/embed?mid=1hJVyJoNueMxzMneUN-bEYcYni2i6fuQ&ehbc=2E312F");
            break;
        case "VALORHISTO":
            VALORHISTO_Img = true;
        ...
        case "DANZA":
            ...
            ChangeDescripcion('COLUMNAS SALOMÓNICAS');
            $("#DanzaDescripcion").css('display', 'block');
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=00fe937567&commit=b6cc2977a3&c=%5B5.90455%2C14.84204%2C5.2304%2C11.37982%2C0.66339%2C5.2304%2C0%2C1%5D&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "MEMORIA":
            MEMORIA_Img = true;
            ChangeSelloImage('SELLO_MEMORIA');
            ChangeDescripcion('VENTANA');
            $("#MemoriaDescripcion").css('display', 'block');
            $("#ContainerDesctipcion").css('height', '36vh');
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=8b8db2727d&commit=1fe234966d&c=%5B-18.15596%2C17.02075%2C4.15512%2C-8.30729%2C7.99108%2C4.15512%2C0%2C1%5D&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "ARTESANIA":
            ARTESANIA_Img = true;
