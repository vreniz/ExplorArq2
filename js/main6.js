...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "VALORESTETICO":
            ...
            $("#MapsFrame").attr("src", "https://www.google.com/maps/d/embed?mid=1toMrkQej7NfBJL_FO1I0bL82A1Fp7ks&ehbc=2E312F");
            break;
        case "VALORHISTO":
            VALORHISTO_Img = true;
        ...
        case "DANZA":
            ...
            ChangeDescripcion('ACCESO');
            $("#DanzaDescripcion").css('display', 'block');
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=67bb777d76&commit=3333f0bf34&c=%5B-13.84308%2C32.86179%2C10.79286%2C2.48326%2C1.6476%2C10.79286%2C0%2C1%5D&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "MEMORIA":
            MEMORIA_Img = true;
