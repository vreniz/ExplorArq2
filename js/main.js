...
$("document").ready(function() {
    //image INICIO
    $("#img_INICIO").mouseenter(function() {
        $(this).attr('src', 'img/buttons/Green/INICIO.png');
    });
    //image INICIO hover
    $("#img_INICIO").mouseleave(function() {
        if (INICIO_Img != true) {
            $(this).attr('src','img/buttons/White/INICIO.png');
        }
    });
...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "INICIO":
            INICIO_Img = true;
            ChangeSelloImage('SELLO_INICIO');
            ChangeDescripcion('VALOR ESTETICO');
            $("#INICIODescripcion").css('display', 'block');
...
function Default_Image_Button_Option() {
    $("#img_INICIO").attr('src', 'img/buttons/White/INICIO.png');
...
function HideTextDescripcion(){
    $("#INICIODescripcion").css('display', 'none');
