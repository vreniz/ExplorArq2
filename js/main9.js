...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "VALORESTETICO":
            ...
            $("#MapsFrame").attr("src", "https://www.google.com/maps/d/embed?mid=1aBk6_56_Da0sEqj6YLcwiRZezW8jdlQ&ehbc=2E312F");
            break;
        case "VALORHISTO":
            VALORHISTO_Img = true;
        ...
        case "DANZA":
            ...
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=86de782b62&commit=61df1657a1&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "MEMORIA":
            MEMORIA_Img = true;
