...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "VALORESTETICO":
            ...
            $("#MapsFrame").attr("src", "https://www.google.com/maps/d/embed?mid=18INFGRlbGwWyrcVTciC0e-oiDdLuKhY&ehbc=2E312F");
            break;
        case "VALORHISTO":
            VALORHISTO_Img = true;
        ...
        case "DANZA":
            ...
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=a90708a3b4&commit=ddef332690&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "MEMORIA":
            MEMORIA_Img = true;
