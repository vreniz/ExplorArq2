...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "VALORESTETICO":
            ...
            $("#MapsFrame").attr("src", "https://www.google.com/maps/d/embed?mid=1hxuoCMVtO36nqBmAj85C6TzJGpN3ohU&ehbc=2E312F");
            break;
        case "VALORHISTO":
            VALORHISTO_Img = true;
        ...
        case "DANZA":
            ...
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=74215fce48&commit=0ede3cb280&c=%5B7.21985%2C21.00988%2C8.91933%2C-3.5143%2C0.97794%2C8.91933%2C0%2C1%5D&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "MEMORIA":
            MEMORIA_Img = true;
