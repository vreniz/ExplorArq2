...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "VALORESTETICO":
            ...
            $("#MapsFrame").attr("src", "https://www.google.com/maps/d/embed?mid=1-KVJwDnCXr-KAutKVbvheu_SFjtiZqk&ehbc=2E312F");
            break;
        case "VALORHISTO":
            VALORHISTO_Img = true;
        ...
        case "DANZA":
            ...
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=77e1abc2c3&commit=43c470e916&c=%5B11.23018%2C14.13778%2C4.74115%2C6.28709%2C1.46315%2C4.74115%2C0%2C1%5D&autoload=true&hidecontrols=true&hidesidebar=true");
            break;
        case "MEMORIA":
            MEMORIA_Img = true;
