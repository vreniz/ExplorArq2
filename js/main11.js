...
function Click_Image_Button_Option(image_id) {
    ...
    switch (image_id) {
        case "VALORESTETICO":
            ...
            $("#MapsFrame").attr("src", "https://www.google.com/maps/d/embed?mid=16t54nwg6nPvgaX_eCho1QdVMV58xHk0&ehbc=2E312F");
            break;
        case "VALORHISTO":
            VALORHISTO_Img = true;
        ...
        case "DANZA":
            ...
            $("#MapsFrame").attr("src", "https://speckle.xyz/embed?stream=3e0cc1b310&commit=f946691105&c=%5B0.73704%2C17.42862%2C3.36222%2C-4.37286%2C0.82053%2C3.24632%2C0%2C1%5D");
            break;
        case "MEMORIA":
            MEMORIA_Img = true;
            ChangeSelloImage('SELLO_MEMORIA');
            ChangeDescripcion('PUERTA');
